    ...
    try {
      ...
      if(apiResponse.status==200){
        ...
        apiResponse.data.bookData.forEach((eachBook)=>{
          //in ! used for check category has not include in this category
    ...
    <>
      ...
      {isloggedIn ? (
        <>
          ...
          <div className="grid grid-cols-6 gap-4 mt-5">
           ...
           <div className="flex flex-col"> 
            <div onClick={getBookData}>
              <input id="inp" name="category" className="me-3" type="radio" />
              <label htmlFor="inp" className="">All</label>
            </div>
              ...
              allcategories.map((eachCategory,index)=>(
                ...
                <input id={index} name="category" className="me-3" type="radio" />
               {eachCategory}
              </label>
                </div>
         ...
         {
          bookData.length>0 ? <div className="grid grid-cols-[1fr_1fr_1fr] gap-5 ">
              {
          ...
          <div className="max-w-sm rounded overflow-hidden shadow-lg mx-auto">
            ...
            <div className="px-6 py-4">
              <div className="font-bold text-xl mb-2">{eachBook.title}</div>
            ...
            <Link to={`/view/${eachBook._id}/book`} className="bg-blue-500 text-white font-bold p-1">View More</Link>
          </div>
        </div>
